...
# wandb 프로젝트 초기화
wandb.init(project='Hanghae99-ssungz')
...
class Arguments:
    ...
    eval_split_percentage: Optional[int] = field(default=10) # validation set %
...
# validation set이 없을 경우에 Train 데이터에서 분할
if "validation" not in raw_datasets:
    raw_datasets = raw_datasets["train"].train_test_split(
        test_size=args.eval_split_percentage/100,
        seed=42
    )
